...
const NAV_GROUPS = [
  ...
  },
  {
    ...
    icon: '',
    subTabs: [
      { id: 'action', label: '⚡ Acties + Risk + Earnings' },
    ],
  },
  {
    id: 'ticker',
    ...
    icon: '',
    subTabs: [
      { id: 'ticker-unified', label: '🎯 Per aandeel (alles inline)' },
    ],
  },
  {
    id: 'portfolio',
  ...
  },
  {
    ...
    icon: '',
    subTabs: [
      { id: 'learnings-hub', label: 'Module hit rate + Attribution' },
      { id: 'paper',         label: '📝 Paper Trades' },
      { id: 'backtest',      label: '🧪 Backtest' },
      { id: 'sources',       label: 'Bronnen + Data' },
    ],
  },
  {
    id: 'briefing',
